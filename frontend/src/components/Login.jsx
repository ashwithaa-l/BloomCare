  ...
  return (
    ...
    <div className='bg-[url("login.png")] h-screen bg-cover'>
      <div className='pt-[10rem]'>  
        <p className='font-bold text-8xl ml-[55rem] mb-[3rem]'>Login</p>
        <p className='font-semibold text-3xl ml-[49rem]'>Log in if account already exist</p>
        </div>
        ...
        <button className='text-3xl font-bold border border-black px-[3rem] py-[1rem] bg-black rounded-[3rem] ml-[55rem] text-white mb-[5rem]'>Login</button>
       ...
       <div className='flex flex-row gap-[3rem] ml-[40rem]'>
        <p className='mt-[1rem] text-3xl font-semibold'>IF YOU DONT HAVE AN ACCOUNT</p>
        <button onClick={handleLoginClick} className='border border-black px-[3rem] py-[1rem] rounded-[3rem] bg-black text-white text-3xl'>Register</button>
        </div>
    </div>
    </>
  )
